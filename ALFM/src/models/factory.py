...
class CLIPImageEncoder(nn.Module):
    """Wrapper to expose CLIP encode_image as an nn.Module.forward.

    Returns L2-normalized embeddings in the shared image-text space.
    """

    def __init__(self, clip_model: open_clip.CLIP) -> None:  # type: ignore[name-defined]
        super().__init__()
...
def create_model(
    ...
    match model_type:
        case ModelType.openclip_vit_B16 | ModelType.openclip_vit_L14 | ModelType.openclip_vit_H14 | ModelType.openclip_vit_g14 | ModelType.openclip_vit_G14 | ModelType.openai_vit_B16:
            ...
            clip_model, transform = result

            # Use encode_image to stay in the shared CLIP embedding space
