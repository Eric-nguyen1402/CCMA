...
from ALFM.src.datasets.dataset_wrappers import STL10Wrapper
from ALFM.src.datasets.dataset_wrappers import Caltech101Wrapper
from ALFM.src.datasets.dataset_wrappers import Caltech256Wrapper
from ALFM.src.datasets.dataset_wrappers import SUN397Wrapper
...
class DatasetType(Enum):
    ...
    dtd = DTDWrapper()
    stl10 = STL10Wrapper()
    caltech101 = Caltech101Wrapper()
    caltech256 = Caltech256Wrapper()
    sun397 = SUN397Wrapper()
